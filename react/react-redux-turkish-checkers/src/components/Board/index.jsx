...
function Board() {
  ...
  //console.log("--->>>", rows);
  return (
    <div className="w-[800px] h-[800px] flex flex-col items-center justify-center mx-auto rounded" id="board-row">
      ...
      <div className="ml-[105px] flex items-center justify-center flex-nowrap text-white mt-4">
